...
function ManageCourseData() {
  ...
  const updateBtn = async () => {
    ...
    try {
      // courseName = selectedCourse.courseCode
      ...
      // console.log(selectedCourse.intake);
      console.log(getManageSelectedIntakeValues);
      console.log(getManageClassificationValues);
      // console.log("update" + course_code);
      // console.log("initial" + courseCodeForUpdate);
      // const coursegetData = await getDoc(
      //   doc(firestore, "course", courseCodeForUpdate)
      // );
      ...
      //   credit_hour: selectedCourse.creditHours,
      //   intake: selectedCourse.intake,
      //   classification: selectedCourse.classification,
      //   remark: remarkValueManage,
      //   registerStatus: selectedCourse.registerStatus,
      // });
